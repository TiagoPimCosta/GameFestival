...
public class JanelaLogin extends JDialog {    
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtUtilizador, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 210, 26));
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 210, 27));
        ...
        getContentPane().add(btnOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 100, 30));
        ...
        getContentPane().add(btnSair, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 100, 30));
